...
#
# One template renders TWO files per component: umbreed/install.sh (the stable
# channel) and, while a beta cycle is open, its twin umbreed/beta.install.sh
...
#
# DO NOT EDIT generated copies (umbreed/install.sh, umbreed/beta.install.sh) by
...
# property of WHICH URL was published (release.umbree.org/umbreed/install.sh vs
